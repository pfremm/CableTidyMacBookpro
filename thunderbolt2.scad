...
module thunderbolt2(cutout=false) {
  // main body
  color("White")
  hull() {
    if (cutout == true) {
      translate([-(tb_body_width2/2), -(tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length * 2, center=true);
      translate([ (tb_body_width2/2), -(tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length * 2, center=true);
      translate([ (tb_body_width2/2),  (tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length * 2, center=true);
      translate([-(tb_body_width2/2),  (tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length * 2, center=true);
    } else {
      translate([-(tb_body_width2/2), -(tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length, center=true);
      translate([ (tb_body_width2/2), -(tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length, center=true);
      translate([ (tb_body_width2/2),  (tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length, center=true);
      translate([-(tb_body_width2/2),  (tb_body_height2/2), 0]) cylinder(r=tb_body_fillet_radius, h=tb_body_length, center=true);
    }
